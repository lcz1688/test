...
public abstract class MvpRxPresenter<M extends MvpModel, V extends MvpView>
     ...
     */
    public <BEAN extends Object> void getNetWork(Observable<BEAN> observable, Subscriber<BEAN> sb) {
        unsubscribe();
        subscriber = sb;
     ...
     */
    protected <BEAN extends Object> Observable<BEAN> applyScheduler(Observable<BEAN> observable) {
